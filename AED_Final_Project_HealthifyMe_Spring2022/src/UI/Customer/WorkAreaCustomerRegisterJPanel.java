 ...
 */
public class WorkAreaCustomerRegisterJPanel extends javax.swing.JPanel {

    /**
     * Creates new form CustomerRegisterWorkAreaJPanel
     */
    ...
    public WorkAreaCustomerRegisterJPanel(JPanel userProcessContainer, EcoSystem system) {
        initComponents();
    ...
    private void getValuesFromTextField(Customer customer) {
        if (userNameTextField.getText().isEmpty() || firstNameTextField.getText().isEmpty() || ageTextField.getText().isEmpty()
            ...
            try {
                ...
                if (ValidationUtils.validateMobnumber(mobileNumberTextField.getText())) {
    ...
    private void initComponents() {
        ...
        add(userNameTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 320, 200, -1));
        ...
        add(genderComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 190, 200, -1));
        ...
        registerBtn1.setBackground(new java.awt.Color(255, 102, 102));
        registerBtn1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        add(passwordTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 380, 200, -1));
        add(reenterPasswordTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 380, 200, -1));

        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/customerREGISTRATION.png"))); // NOI18N
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 1800, 1200));
