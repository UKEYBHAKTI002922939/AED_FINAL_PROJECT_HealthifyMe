...
public class RequestMeditationInstructorJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form RequestMeditationInstructorJPanel
     */
    ...
    public RequestMeditationInstructorJPanel(JPanel userProcessContainer, UserAccount account, Enterprise enterprise, EcoSystem system, Network sourceNetwork, Network targetNetwork) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(enterpriseLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 130, -1, 30));

        valueLabel.setText("xyz");
        add(valueLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 130, 110, 30));
        ...
        add(messageJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 180, 100, -1));
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 111, -1));
    ...
    private void requestTestJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButtonActionPerformed
        ...
        if (!message.isEmpty()) {
            MeditationInstructorWorkRequest request = new MeditationInstructorWorkRequest();
