 ...
 */
public class RequestGymInstructorJPanel extends javax.swing.JPanel {

    /**
     * Creates new form RequestGymInstructorJPanel
     */
    ...
    public RequestGymInstructorJPanel(JPanel userProcessContainer, UserAccount account, Enterprise enterprise, EcoSystem system, Network sourceNetwork, Network targetNetwork) {
        initComponents();
    ...
    private void requestTestJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButtonActionPerformed
        ...
        if (!message.isEmpty()) {
            GymInstructorWorkRequest request = new GymInstructorWorkRequest();
            ...
            if (sourceNetwork != targetNetwork) {
                for (Enterprise enterprise : targetNetwork.getEnterpriseDirectory().getEnterpriseList()) {
                    ...
                    for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
                        if (organization instanceof GymOrganization) {
                            org = organization;
                            break;
                        }
                    }
